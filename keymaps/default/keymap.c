...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *           │   \   │  󰘶  │
    ...
    [0] = LAYOUT(
        KC_NO,          KC_1,           KC_2,           KC_3,       KC_4,    KC_5,      KC_PRINT_SCREEN,
        KC_NO,          KC_SCLN,        KC_COMMA,       KC_DOT,     KC_P,    KC_Y,      KC_AUDIO_VOL_UP,
        TG(2),          KC_A,           KC_O,           KC_E,       KC_U,    KC_I,      KC_AUDIO_VOL_DOWN,
        KC_LEFT_SHIFT,  KC_QUOTE,       KC_Q,           KC_J,       KC_K,    KC_X,      KC_AUDIO_MUTE,
                        TG(3),          TG(4),

                        MT(MOD_LGUI, KC_ESCAPE),    LT(1, KC_SPACE),
                        TG(1),                      KC_LEFT_SHIFT,
